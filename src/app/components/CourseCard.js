    ...
    return (
        <div className="bg-white rounded-lg shadow-lg overflow-hidden w-full max-w-xs mx-4">
            <div className="p-5">
                ...
                <h2 className="mt-4 font-bold text-xl">Java Full-Stack Development Track</h2>
                <p className="mt-2 text-gray-600 text-sm">Master DSA, Problem Solving, Full Stack and crack top Software Development jobs</p>
                ...
                <div className="mt-4">
                    <div className="flex items-center text-sm text-gray-600">
                        ...
                        <span className="ml-2">Duration: 8 Months</span>
                    </div>
                    <div className="flex items-center text-sm text-gray-600 mt-2">
                        ...
                        <span className="ml-2">Seats Left: 28</span>
                    </div>
                </div>
