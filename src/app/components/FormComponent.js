...
const FormComponent = () => {
  return (
    ...
    <div className="max-w-sm mx-auto my-10 bg-white p-8 rounded-lg shadow-md">
    <h2 className="text-2xl font-semibold text-center text-gray-800">Start learning for <span className="text-blue-600">FREE</span></h2>
